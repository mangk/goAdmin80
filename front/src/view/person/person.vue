...
<!--                </li>-->
    ...
    >
      <el-form
        ...
        label-width="80px"
      >
        <el-form-item :minlength="4" label="原密码" prop="password">
          <el-input v-model="pwdModify.password" show-password />
        </el-form-item>
        <el-form-item :minlength="4" label="新密码" prop="newPassword">
          <el-input v-model="pwdModify.newPassword" show-password />
        </el-form-item>
        <el-form-item :minlength="4" label="确认密码" prop="confirmPassword">
...
const rules = reactive({
  password: [
    ...
    { min: 4, message: '最少6个字符', trigger: 'blur' },
  ],
  newPassword: [
